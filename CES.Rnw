...
The best fit for the UK appears to be $\rho_1 \rightarrow -1$ ($\sigma_1 \rightarrow \infty$, meaning perfect subsitutibility between $k$ and $l$). It is unclear why there is a sudden dropoff in $-SSE$ at larger values of $\rho$.
