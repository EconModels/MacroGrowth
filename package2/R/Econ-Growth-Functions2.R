...
#' 
#' @param formala a formual of the form \code{y ~ capital + labor + time}
...
#' 
#' @param formula a formula of the form \code{y ~ capital + labor + energy + time}
...
#' Fit LINEX models
#' 
#' @param formula a formula of the form \code{y ~ captial + labor + energy + time}
#' @param data a data frame in which \code{formula} is evaluated
#' @export
#' 
