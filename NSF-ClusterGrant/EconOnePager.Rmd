...
on our current hardware in a few hours.

Our plans for future work will require significantly-improved computational capabilities.
Each of the planned activities below will require days to run on existing hardware.
...
* We have in hand data from several additional countries that we would like to
anaylze by similar methods as discussed above.

* We want to explore the quality and performance
of the bootstrap resampling and/or Bayesian estimation techniques.

* Our collaborators in Portugal have completed a paper that employs the 
Cobb-Douglas APF in combination with statistical co-integration techniques to understand
the relationship between energy and the economy in Portugal [@jsantos2016]. 
Their next step is to switch from the Cobb-Douglas APF to the CES APF.
At the Second Exergy Economics Workshop (Sussex, England, July 2016), 
we made plans to collaborate. 
Our CES fitting techniques and resampling methods
will be applied to their cointegration analysis
to develop the data for new paper analyzing the Portuguese economy.
