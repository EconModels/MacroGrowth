...
In a recently submitted paper [@Heun:2016] we investigated these effects
...
Each of our planned activities below will require days to run on existing hardware.
...
to write a new paper analyzing the Portuguese economy.
