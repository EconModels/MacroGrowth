...
\includegraphics[width=\maxwidth]{figure/Lattice_Factors_Graph} \caption[Factors of Production for All Countries]{Factors of Production for All Countries. (China's indexed capital stock rises to $k = 9.2$ in 2011.)\label{fig:Lattice Factors Graph}}
\end{figure}
