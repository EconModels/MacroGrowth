...
\hlcomment{#   This may be any of heat (iQ), exergy (iX), or useful work (iU).}
\hlcomment{##}
cobbDouglasEnergy <- \hlfunctioncall{function}(dataTable, energyColumnName, energyString)\{
...
\hlcomment{  # * gamma = 1 - max(a, b)}
  iEnergy <- dataTable[energyColumnName] \hlcomment{#grabs the energy column}
  lambdaGuess <- 0.0 \hlcomment{# guessing lambda = 0 means there is no technological progress.}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
dataCDq <- \hlfunctioncall{cobbDouglasEnergy}(dataTable, \hlstring{"iQ"}, \hlstring{"q"})
\end{alltt}
\begin{verbatim}
[1] -161.1
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
dataCDx <- \hlfunctioncall{cobbDouglasEnergy}(dataTable, \hlstring{"iX"}, \hlstring{"x"})
\end{alltt}
\begin{verbatim}
[1] -161.4
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
dataCDu <- \hlfunctioncall{cobbDouglasEnergy}(dataTable, \hlstring{"iU"}, \hlstring{"U"})
\end{alltt}
...
\end{alltt}
\end{kframe}
\includegraphics[width=.45\textwidth,height=.38\textwidth]{figure/unnamed-chunk-11} 
\begin{kframe}\begin{alltt}
\hlfunctioncall{histogram}( ~\hlfunctioncall{resid}(modelCESQ) )
\end{alltt}
\end{kframe}
\includegraphics[width=.45\textwidth,height=.38\textwidth]{figure/unnamed-chunk-12} 
\begin{kframe}\begin{alltt}
\hlfunctioncall{qqmath}( ~\hlfunctioncall{resid}(modelCESQ) )
\end{alltt}
\end{kframe}
\includegraphics[width=.45\textwidth,height=.38\textwidth]{figure/unnamed-chunk-13} 
