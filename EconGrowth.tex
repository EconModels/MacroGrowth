...
createCountryGraph <- \hlfunctioncall{function}(countryName)\{
...
\hlcomment{#graph <- createCountryGraph("US")}
\hlfunctioncall{print}(\hlfunctioncall{createCountryGraph}(\hlstring{"US"}))
\end{alltt}
\end{kframe}
\includegraphics[width=.45\textwidth,height=.38\textwidth]{figure/creategraph} 
