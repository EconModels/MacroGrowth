...
\includegraphics[width=\maxwidth]{figure/Factors_Lattice_Graph} \caption[Indexed GDP ($y$), capital stock ($k$), labor ($l$), thermal energy ($q$), exergy ($x$), and useful work ($u$) for all economies]{Indexed GDP ($y$), capital stock ($k$), labor ($l$), thermal energy ($q$), exergy ($x$), and useful work ($u$) for all economies. (China's indexed GDP and indexed capital stock rise to $y = 7.3$ and $k = 9.2$ in 2011.)\label{fig:Factors_Lattice_Graph}}
\end{figure}
...
{\ttfamily\noindent\color{warningcolor}{Warning: Convergence failure: false convergence (8)}}\begin{verbatim}
Nonlinear regression model
  model:  iGDP ~ exp(lambda * iYear) * iCapStk^min(a, b) * iLabor^abs(b -      a) * iEnergy^(1 - max(a, b)) 
   data:  dataTable 
 lambda       a       b 
0.00877 0.54436 0.88424 
 residual sum-of-squares: 0.262
...
US & 0.0087 & 0.0102 & 0.0116 & 0.21 & 0.27 & 0.34 & 0.66 & 0.73 & 0.79 \\ 
  UK & -0.0066 & 0.0097 & 0.0215 &  & 0.44 &  & -0.13 & 0.56 & 1.24 \\ 
  JP & 0.0021 & 0.0052 & 0.0082 & 0.44 & 0.52 & 0.59 & 0.41 & 0.48 & 0.56 \\ 
  CN & -0.0021 & 0.0188 & 0.0688 & 0.11 & 0.71 &  & -0.32 & 0.29 & 0.89 \\ 
  ...
  ZM & 0.0154 & 0.0174 & 0.0191 & 0.93 & 1.00 &  & -0.25 & 0.00 & 0.25 \\ 
   \hline
\end{tabular}
\end{center}
\end{table}
...
{\ttfamily\noindent\itshape\color{messagecolor}{Waiting for profiling to be done...}}\end{kframe}\begin{figure}[]
