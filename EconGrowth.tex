...
createCountryInputGraph <- \hlfunctioncall{function}(countryName)\{
  dataTable <- \hlfunctioncall{loadData}(countryName)
  graph <- \hlfunctioncall{xyplot}(iGDP+iQ+iX+iCapStk+iLabor ~ iYear, data=dataTable,
                  type=\hlstring{"l"},
                  scales=\hlfunctioncall{list}(cex=1.0, tck=-0.5),
                  ylab=\hlstring{"\hlfunctioncall{Indexed} (1980=1)"},
                  auto.key=\hlfunctioncall{list}(columns=1, x=0.0, y=0.98))
  \hlfunctioncall{return}(graph)
\}

\hlfunctioncall{createCountryInputGraph}(\hlstring{"US"})
\end{alltt}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/creategraph1} 
\begin{kframe}\begin{alltt}
\hlfunctioncall{lapply}(countries, createCountryInputGraph)
\end{alltt}
\begin{verbatim}
$US
\end{verbatim}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/creategraph2} 
\begin{kframe}\begin{verbatim}

$UK
\end{verbatim}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/creategraph3} 
\begin{kframe}\begin{verbatim}

$JP
\end{verbatim}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/creategraph4} 
\begin{kframe}\begin{verbatim}

$ZA
\end{verbatim}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/creategraph5} 
\begin{kframe}\begin{verbatim}

$CN
\end{verbatim}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/creategraph6} 
\begin{kframe}\begin{verbatim}

$IR
\end{verbatim}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/creategraph7} 
\begin{kframe}\begin{verbatim}

$SA
\end{verbatim}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/creategraph8} 
\begin{kframe}\begin{verbatim}

$TZ
\end{verbatim}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/creategraph9} 
\begin{kframe}\begin{verbatim}

$ZM
\end{verbatim}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/creategraph10} 
