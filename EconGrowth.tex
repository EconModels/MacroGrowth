...
\hlfunctioncall{print}(\hlfunctioncall{coef}(usModel))
\end{alltt}
\begin{verbatim}
 lambda   alpha 
0.01016 0.27418 
\end{verbatim}
\begin{alltt}
usPred <- \hlfunctioncall{predict}(usModel)
...
\end{verbatim}
\begin{alltt}
\hlfunctioncall{print}(usPred)
\end{alltt}
\begin{verbatim}
 [1] 1.000 1.021 1.026 1.057 1.119 1.162 1.196 1.244 1.296 1.348 1.375
[12] 1.383 1.408 1.458 1.520 1.579 1.628 1.702 1.772 1.844 1.912 1.941
[23] 1.963 1.997 2.058 2.128 2.204 2.260 2.281 2.215 2.241 2.323
\end{verbatim}
\begin{alltt}
