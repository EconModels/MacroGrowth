...
\hlcomment{#}
\hlcomment{# countryName = a string of the 2-digit code for the country for which data is to be loaded. }
\hlcomment{#   The file name from which data will be loaded is assumed to be of the form }
\hlcomment{#   "<countryName>Data.txt". The file is assumed to exist in a subfolder of this project called "data".}
\hlcomment{#}
...
\hlcomment{  # Identifies the header names associated with dataTable}
  \hlfunctioncall{print}(\hlfunctioncall{names}(dataTable))
...
\hlfunctioncall{print}(tableCD)
\end{alltt}
\begin{verbatim}
% latex table generated in R 2.15.2 by xtable 1.7-0 package
% Mon Jan 21 13:15:11 2013
\begin{table}[ht]
\begin{center}
\begin{tabular}{rrrrr}
  \hline
...
tablesCD <- \hlfunctioncall{lapply}(countries, cobbDouglas)
\end{alltt}
\begin{verbatim}
 [1] "Year"                                     
 [2] "GDP.Millionsofreal2005USdollars."         
...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error: line 1 did not have 33 elements}}\begin{alltt}
\hlcomment{#tablesCD <- sapply(countries, cobbDouglas, USE.NAMES = TRUE)}
\end{alltt}
\end{kframe}
\end{knitrout}
