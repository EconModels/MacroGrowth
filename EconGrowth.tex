...
createCountryFactorsGraph <- \hlfunctioncall{function}(countryName)\{
  ...
  colors <- \hlfunctioncall{c}(\hlstring{"black"}, \hlstring{"black"}, \hlstring{"black"}, \hlstring{"black"}) #line and point colors
  lineWidths <- \hlfunctioncall{c}(1, 1, 1, 1) \hlcomment{#line widths}
  lineTypes <- \hlfunctioncall{c}(1, 5, 2, 4) \hlcomment{#line types. See http://en.wikibooks.org/wiki/R_Programming/Graphics}
...
\end{alltt}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/graphs1} 
\begin{kframe}\begin{alltt}

\hlfunctioncall{createCountryFactorsGraph}(\hlstring{"US"})
\end{alltt}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/graphs2} 
\begin{kframe}\begin{alltt}
