...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlcomment{#countryName <- "ZA"}
\hlcomment{#energyType <- "Q"}
\hlcomment{#tableCDq <- cobbDouglasEnergyTable(countryName, energyType)}
