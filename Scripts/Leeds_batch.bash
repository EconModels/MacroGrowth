...
ssh node-22 "cd $LOC_PATH; $EXEC -c US,UK,CN -e iXp -m cese-\(kl\)e -S $SRC $1 &> $OUTDIR/node-22.txt" &
ssh node-23 "cd $LOC_PATH; $EXEC -c US,UK,CN -e iXp -m cese-\(le\)k -S $SRC $1 &> $OUTDIR/node-23.txt" &
