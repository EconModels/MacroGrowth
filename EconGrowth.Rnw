...
opts_chunk$set(
  ...
  eval=TRUE,
  # ********************************************************************************************************
  warning=FALSE, #Tells whether to show warnings.
...
###############################
# Tells whether we have data for this combination of country and energy type.
...
##
haveData <- function(countryAbbrev, energyType){
...
covarianceTable <- function(countryAbbrev){
  ...
  covarXtable <- xtable(covarResults, 
                      caption=paste("Covariance table for ", countryAbbrev, "economy."), 
...
<<Factors_Lattice_Graph, fig.width=figWidth, fig.height=figHeight, fig.pos="H", fig.cap="Historical data. Indexed GDP ($y$), capital stock ($k$), labor ($l$), thermal energy ($q$), exergy ($x$), and useful work ($u$).">>=
...
singleFactorPredictions <- function(countryAbbrev, factor){
  ...
  if (factor == "U"){
    if (!(haveData(countryAbbrev, factor))){
...
createSFLatticeGraph <- function(){
  ...
  graphType <- "b" #b is for both line and symbol
  lineTypes <- c(0, 1, 2, 4, 1, 1) #line types. See http://en.wikibooks.org/wiki/R_Programming/Graphics
  lineWidths <- c(0, 2, 1, 1, 1, 1) #line widths. 0 means no line.
  colors <- c("black", "black", "red", "blue", "darkorange", "darkgreen") #line and symbol colors
  symbols <- c(1, NA, NA, NA, NA, NA)  #NA gives no symbol.
...
# print(singleFactorPredictions("US", "K"))
# print(singleFactorPredictionsColumn("K"))
# print(singleFactorPredictionsColumn("L"))
# print(singleFactorPredictionsColumn("Q"))
# print(singleFactorPredictionsColumn("X"))
# print(singleFactorPredictionsColumn("U"))
# print(createSFLatticeGraph())
...
<<SF_GDP_Lattice_Graph, fig.width=figWidth, fig.height=figHeight, fig.pos="H", fig.cap="Single-factor results.">>=
...
cobbDouglasPredictions <- function(countryAbbrev, energyType){
  ...
  if (!missing(energyType)){
    ...
    if (!(haveData(countryAbbrev, energyType))){
      #If we don't have data for this combination of countryAbbrev and energyType, 
      # return a column of NAs if the above conditions have been met.
      nRows <- 21 # All of these countries need 21 rows.
      df <- as.data.frame(matrix(NA, ncol = 1, nrow = nRows))
...
<<CD_Params_Graph, fig.width=figWidth, fig.height=5, fig.pos="H", fig.cap="Cobb-Douglas (without energy) model parameters. Vertical bars indicate 95\\% confidence intervals.">>=
createCDParamsGraph()
@
...
<<CDq_Params_Graph, fig.width=figWidth, fig.height=5, fig.pos="H", fig.cap="Cobb-Douglas (with $q$) model parameters. Vertical bars indicate 95\\% confidence intervals.">>=
...
<<CDx_Params_Graph, fig.width=figWidth, fig.height=5, fig.pos="H", fig.cap="Cobb-Douglas (with $x$) model parameters. Vertical bars indicate 95\\% confidence intervals.">>=
...
<<CDu_Params_Graph, fig.width=figWidth, fig.height=5, fig.pos="H", fig.cap="Cobb-Douglas (with $u$) model parameters. Vertical bars indicate 95\\% confidence intervals.">>=
...
<<CD_GDP_Lattice_Graph, fig.width=figWidth, fig.height=figHeight, fig.pos="H", fig.cap="Cobb-Douglas results.">>=
...
<<Covariance_Table_US, results='asis'>>=
print(covarianceTable("US"), 
                      caption.placement="top", 
                      sanitize.rownames.function = identity,
...
<<Covariance_Table_UK, results='asis'>>=
print(covarianceTable("UK"), 
                      caption.placement="top", 
                      sanitize.rownames.function = identity,
                      sanitize.colnames.function = identity,
                      table.placement="H")
...
<<Covariance_Table_JP, results='asis'>>=
print(covarianceTable("JP"), 
                      caption.placement="top", 
                      sanitize.rownames.function = identity,
                      sanitize.colnames.function = identity,
                      table.placement="H")
...
<<Covariance_Table_CN, results='asis'>>=
print(covarianceTable("CN"), 
                      caption.placement="top", 
                      sanitize.rownames.function = identity,
                      sanitize.colnames.function = identity,
                      table.placement="H")
...
<<Covariance_Table_ZA, results='asis'>>=
print(covarianceTable("ZA"), 
                      caption.placement="top", 
                      sanitize.rownames.function = identity,
                      sanitize.colnames.function = identity,
                      table.placement="H")
...
<<Covariance_Table_SA, results='asis'>>=
print(covarianceTable("SA"), 
                      caption.placement="top", 
                      sanitize.rownames.function = identity,
                      sanitize.colnames.function = identity,
                      table.placement="H")
...
<<Covariance_Table_IR, results='asis'>>=
print(covarianceTable("IR"), 
                      caption.placement="top", 
                      sanitize.rownames.function = identity,
                      sanitize.colnames.function = identity,
                      table.placement="H")
...
<<Covariance_Table_TZ, results='asis'>>=
print(covarianceTable("TZ"), 
                      caption.placement="top", 
                      sanitize.rownames.function = identity,
                      sanitize.colnames.function = identity,
                      table.placement="H")
...
<<Covariance_Table_ZM, results='asis'>>=
print(covarianceTable("ZM"), 
                      caption.placement="top", 
                      sanitize.rownames.function = identity,
                      sanitize.colnames.function = identity,
                      table.placement="H")
