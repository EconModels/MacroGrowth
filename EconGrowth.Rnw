...
The Cobb-Douglas with energy parameter estimation process is problematic. The following graphs show that the minimum of the squared-errors curve occurs at the point where $\beta$ --> 0.0.
