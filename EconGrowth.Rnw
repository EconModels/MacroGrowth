...
covarianceTable <- function(countryAbbrev){
  ...
  covarXtable <- xtable(covarResults, 
                      caption=paste("Covariance table for ", countryAbbrev, ".", sep=""), 
...
<<Factors_Lattice_Graph, fig.width=figWidth, fig.height=ninePanelGraphHeight, fig.pos="H", fig.cap="Historical data. Indexed GDP ($y$), capital stock ($k$), labor ($l$), thermal energy ($q$), exergy ($x$), and useful work ($u$).">>=
...
singleFactorModel <- function(countryAbbrev, factor){
  ...
  modelSF <- nls(iGDP ~ exp(lambda*iYear) * f^m, 
                 data=dataTable, 
...
# Prints a covariance table for countryAbbrev
##
printSingleFactorParamsTable <- function(factor){
...
createSFParamsGraph <- function(factor){
  ...
  graph <- segplot(country ~ upperCI + lowerCI | parameter, 
                   ...
                   strip = strip.custom(bg="white", factor.levels=c("$\\lambda$", "$m$")),
...
<<SFk_Params_Graph, fig.width=figWidth, fig.height=parameterGraphHeight, fig.pos="H", fig.cap="Single-factor (with $k$) model parameters. Vertical bars indicate 95\\% confidence intervals.", eval=TRUE>>=
createSFParamsGraph("K")
@

<<SFl_Params_Graph, fig.width=figWidth, fig.height=parameterGraphHeight, fig.pos="H", fig.cap="Single-factor (with $l$) model parameters. Vertical bars indicate 95\\% confidence intervals.", eval=TRUE>>=
createSFParamsGraph("L")
@

<<SFq_Params_Graph, fig.width=figWidth, fig.height=parameterGraphHeight, fig.pos="H", fig.cap="Single-factor (with $q$) model parameters. Vertical bars indicate 95\\% confidence intervals.", eval=TRUE>>=
createSFParamsGraph("Q")
@

<<SFx_Params_Graph, fig.width=figWidth, fig.height=parameterGraphHeight, fig.pos="H", fig.cap="Single-factor (with $x$) model parameters. Vertical bars indicate 95\\% confidence intervals.", eval=TRUE>>=
createSFParamsGraph("X")
@

<<SFu_Params_Graph, fig.width=figWidth, fig.height=parameterGraphHeight, fig.pos="H", fig.cap="Single-factor (with $u$) model parameters. Vertical bars indicate 95\\% confidence intervals.", eval=TRUE>>=
...
<<SF_GDP_Lattice_Graph, fig.width=figWidth, fig.height=ninePanelGraphHeight, fig.pos="H", fig.cap="Single-factor results.">>=
...
<<CD_Params_Graph, fig.width=figWidth, fig.height=parameterGraphHeight, fig.pos="H", fig.cap="Cobb-Douglas (without energy) model parameters. Vertical bars indicate 95\\% confidence intervals.">>=
createCDParamsGraph()
@
...
<<CDq_Params_Graph, fig.width=figWidth, fig.height=parameterGraphHeight, fig.pos="H", fig.cap="Cobb-Douglas (with $q$) model parameters. Vertical bars indicate 95\\% confidence intervals.">>=
...
<<CDx_Params_Graph, fig.width=figWidth, fig.height=parameterGraphHeight, fig.pos="H", fig.cap="Cobb-Douglas (with $x$) model parameters. Vertical bars indicate 95\\% confidence intervals.">>=
...
<<CDu_Params_Graph, fig.width=figWidth, fig.height=parameterGraphHeight, fig.pos="H", fig.cap="Cobb-Douglas (with $u$) model parameters. Vertical bars indicate 95\\% confidence intervals.">>=
...
<<CD_GDP_Lattice_Graph, fig.width=figWidth, fig.height=ninePanelGraphHeight, fig.pos="H", fig.cap="Cobb-Douglas results.">>=
...
The following tables provide tabular results for single-factor models.
...
printSingleFactorParamsTable("K")
printSingleFactorParamsTable("L")
printSingleFactorParamsTable("Q")
printSingleFactorParamsTable("X")
printSingleFactorParamsTable("U")
@
...
The following tables provide tabular results for Cobb-Douglas models with various energy terms.
...
<<CDu_Params_Table, results='asis'>>=
print(cobbDouglasParamsTableWithEnergy("U"), 
      caption.placement="top", 
      sanitize.colnames.function = identity, 
      size="\\tiny",
      table.placement="H")
...
createAICTable <- function(){
  ...
  # Cobb-Douglas with U
  cdUModels <- c(cobbDouglasModel("US", "U"), cobbDouglasModel("UK", "U"), cobbDouglasModel("JP", "U"))
  ...
  out <- rbind(aicSFk, aicSFl, aicSFq, aicSFx, aicSFu, aicCD, aicCDq, aicCDx, aicCDu) 
