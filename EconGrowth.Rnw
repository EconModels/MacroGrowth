...
Added some text here to see what changes.
Adding more text after adding more file types to .gitignore.
...
#   print("")
#   print(paste("In singleFactorData:", countryAbbrev, factor))
#   print("summarySF:")
#   print(paste("    df:", summarySF$df))
#   print(paste("    sigma:", summarySF$sigma))
#   print("    coeffs: ")
#   print(summarySF$coefficients)
#   print("ciSF:")
#   print(ciSF)
  #Single factor model
...
<<SF_Params_Tables, results='asis', eval=TRUE>>=
# print(singleFactorParamsTable("Q"),
#      caption.placement="top", 
#      sanitize.colnames.function = identity, 
#      size="\\tiny", 
#      table.placement="H")
