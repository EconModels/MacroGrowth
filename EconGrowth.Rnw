...
#
# countryName = a string of the 2-digit code for the country for which data is to be loaded. 
...
countries <- c("US", "CN")
tablesCD <- lapply(countries, cobbDouglas)
#tablesCD <- sapply(countries, cobbDouglas, USE.NAMES = TRUE)
@
