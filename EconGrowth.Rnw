...
tableCD <- xtable(dataCD, caption="U.S. Cobb-Douglas, 1980-2011", digit = c(4))
@
...
tableCDq <- xtable(dataCDq, caption="U.S. 1980-2011.", digit = c(4))

dataAll <- rbind(estCD, estCDq); dataAll
tableAll <- xtable(dataAll, caption="U.S. 1980-2011, All Models.", digit = c(4))
@
