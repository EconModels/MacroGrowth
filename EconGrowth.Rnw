...
cesModel <- function(countryAbbrev, energyType){
  ...
  # This is the version of the function from the Stern and Kander (2012) paper. However, it includes a 
  # 1/sigma exponent on the gamma_E terms, which, I believe, is bogus.
...
#                   + gamma_E^(1.0/sigma)*(exp(lambda_E*iYear) * iEToFit)^((sigma-1.0)/sigma))^(sigma/(sigma-1.0))
  ...
  # This is the corrected version of the Stern and Kander (2012) paper.
...
#                   + gamma_E * (exp(lambda_E*iYear) * iEToFit)^((sigma-1.0)/sigma))^(sigma/(sigma-1.0))
  ...
  # This is the nls fit to the CES model  
...
#                   )
  ...
  # An attempt with nlmrt function nlxb. Doesn't provide many good results.
#   modelCES <- nlxb(model,
#                    data=dataTable,
...
#                   )
  ...
  # Try a fit to a nested CES function with the micEconCES package.  
  # This approach is based on a white paper by Henningsen and Henningsen 
  # http://okonomi.foi.dk/workingpapers/WPpdf/WP2011/WP_2011_9_econometric_estimation_CES.pdf.
  # Set a few of the variables up front
  yName = "iGDP"
  ...
  if (countryAbbrev == "US") {
    ...
    # So, for the final fit, I'll put rho1 = 0.0 and rho = 0.0. The final R^2 = 
    rho1 = 0.0
    rho = 0.0
    modelCES <- cesEst(data=dataTable, yName=yName, xNames=xNames, tName=tName, control=control,
                       method="LM",
...
# print("US U")
# print(summary(cesModel("US", "U")))
# 
# print("")
# print("UK U")
# print(summary(cesModel("UK", "U")))
# 
# print("")
# print("JP U")
# print(summary(cesModel("JP", "U")))
