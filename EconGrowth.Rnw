...
print("US"); print(cobbDouglasPredictions("US", "Q"))
print("UK"); print(cobbDouglasPredictions("UK", "Q"))
print("JP"); print(cobbDouglasPredictions("JP", "Q"))
print("CN"); print(cobbDouglasPredictions("CN", "Q"))
print("ZA"); print(cobbDouglasPredictions("ZA", "Q"))
print("SA"); print(cobbDouglasPredictions("SA", "Q"))
print("IR"); print(cobbDouglasPredictions("IR", "Q"))
print("TZ"); print(cobbDouglasPredictions("TZ", "Q"))
print("ZM"); print(cobbDouglasPredictions("ZM", "Q"))
...
<<CD Params Table, results='asis'>>=
print(cobbDouglasParamsTableNoEnergy(), caption.placement="top", sanitize.colnames.function = identity)
@

<<CD_Params_Graph, fig.width=figWidth, fig.height=3.5, fig.cap="Cobb-Douglas (without energy) model parameters. Vertical bars indicate 95\\% confidence intervals.", eval=FALSE>>=
