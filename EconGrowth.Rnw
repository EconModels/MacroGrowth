...
# List of countries
countries <- c(US="US", UK="UK", JP="JP", ZA = "ZA", CN="CN", IR="IR", SA="SA", TZ="TZ", ZM="ZM")
...
<<Factors of Production Lattice Graph, fig.width=6.5, fig.height=7.5, fig.cap="Factors of Production for All Countries. (China's indexed capital stock rises to $k = 9.2$ in 2011.)", echo=FALSE>>=
