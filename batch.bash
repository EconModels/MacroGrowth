...
ssh node-17 "cd $LOC_PATH; $EXEC -c US,UK,JP -e iX -m cese-\(le\)k -H $HISTDIR -R $OUTDIR $1 &> $OUTDIR/node-17.txt" &
ssh node-18 "cd $LOC_PATH; $EXEC -c CN,ZA,SA -e iX -m cese-\(le\)k -H $HISTDIR -R $OUTDIR $1 &> $OUTDIR/node-18.txt" &
