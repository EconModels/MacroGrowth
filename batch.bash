...
# One bash commandline argument is usd for things like "-n <number> -C -d"  These should be provided 
# as a single quoted string.

LOC_PATH=`pwd`
echo $LOC_PATH

ssh node-01 "cd $LOC_PATH; ./batchEcon.R -c US,UK -e Q -m cese-\(kl\)e $1 > node-01.txt" &
ssh node-02 "cd $LOC_PATH; ./batchEcon.R -c JP,CN -e Q -m cese-\(kl\)e $1 > node-02.txt" &
ssh node-03 "cd $LOC_PATH; ./batchEcon.R -c ZA,SA -e Q -m cese-\(kl\)e $1 > node-03.txt" &
ssh node-04 "cd $LOC_PATH; ./batchEcon.R -c IR,TZ -e Q -m cese-\(kl\)e $1 > node-04.txt" &
ssh node-05 "cd $LOC_PATH; ./batchEcon.R -c ZM    -e Q -m cese-\(kl\)e $1 > node-05.txt" &
ssh node-06 "cd $LOC_PATH; ./batchEcon.R -c US,UK -e Q -m cese-\(le\)k $1 > node-06.txt" &
ssh node-07 "cd $LOC_PATH; ./batchEcon.R -c JP,CN -e Q -m cese-\(le\)k $1 > node-07.txt" &
ssh node-09 "cd $LOC_PATH; ./batchEcon.R -c ZA,SA -e Q -m cese-\(le\)k $1 > node-09.txt" &
ssh node-10 "cd $LOC_PATH; ./batchEcon.R -c IR,TZ -e Q -m cese-\(le\)k $1 > node-10.txt" &
ssh node-12 "cd $LOC_PATH; ./batchEcon.R -c ZM    -e Q -m cese-\(le\)k $1 > node-12.txt" &
ssh node-13 "cd $LOC_PATH; ./batchEcon.R -c US,UK -e Q -m cese-\(ek\)l $1 > node-13.txt" &
ssh node-14 "cd $LOC_PATH; ./batchEcon.R -c JP,CN -e Q -m cese-\(ek\)l $1 > node-14.txt" & 
ssh node-15 "cd $LOC_PATH; ./batchEcon.R -c ZA,SA -e Q -m cese-\(ek\)l $1 > node-15.txt" &
ssh node-16 "cd $LOC_PATH; ./batchEcon.R -c IR,TZ -e Q -m cese-\(ek\)l $1 > node-16.txt" &
ssh node-17 "cd $LOC_PATH; ./batchEcon.R -c ZM    -e Q -m cese-\(ek\)l $1 > node-17.txt" &
...
ssh node-18 "cd $LOC_PATH; ./batchEcon.R -c all -e all -f all -m sf,cd,cde,ces,linex $1 > node-18.txt" &
