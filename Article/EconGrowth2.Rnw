...
**** Original introduction that MKH wrote ****
...
of people under fifteen for other economies 
(China, South Africa, 
Saudi Arabia, Iran, 
Tanzania, and Zambia) 
for 1991--2011. 
...
Figures~\ref{fig:LINEX_abg_traj_graph_CN} and~\ref{fig:LINEX_abg_traj_graph_IR} 
show trajectories for China and Iran, respectively.
**** Can we make a figure that has all 9 graphs in it? --MKH ****

<<LINEX_abg_traj_graph_CN, fig.pos="H", fig.align='center', fig.width=3, fig.height=3.5, fig.cap="LINEX trajectory for China.">>=
dataCN <- fortify(OrigModels$Calvin2011$CN$linex$`iK+iL+iQ`)
...
dataIR <- fortify(OrigModels$Calvin2011$IR$linex$`iK+iL+iQ`)
