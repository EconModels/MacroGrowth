...
cdCoeffsData <- filter(coeffs_df, model=="cd", nestStr %in% c("iK+iL", "iK+iL+iQ", "iK+iL+iX", "iK+iL+iU"))
...
cdFittedData <- filter(fitted_df, model=="cd", nest %in% c("iK+iL", "iK+iL+iQ", "iK+iL+iX", "iK+iL+iU"))
...
cesCoeffsData_kle <- filter(coeffs_df, model=="ces", nestStr %in% c("iK+iL", "iK+iL+iQ", "iK+iL+iX", "iK+iL+iU"))
standardScatterPlot(data=cesCoeffsData_kle, mapping=aes(gamma_coef, lambda), facet_formula=country~nest, alpha=0.05) +
    scale_x_continuous(breaks=c(0.9, 1.0, 1.1)) +
    scale_y_continuous(breaks=c(0, 0.025, 0.05, 0.075)) +    
    labs(x=expression(gamma), y=expression(lambda))
@
...
cesCoeffsData_lek <- filter(coeffs_df, model=="ces", nestStr %in% c("iK+iL", "iL+iQ+iK", "iL+iX+iK", "iL+iU+iK"))
standardScatterPlot(data=cesCoeffsData_lek, mapping=aes(gamma_coef, lambda), facet_formula=country~nest, alpha=0.05) +
    scale_x_continuous(breaks=c(0.9, 1.0, 1.1)) +
    scale_y_continuous(breaks=c(0, 0.025, 0.05, 0.075)) +    
    labs(x=expression(gamma), y=expression(lambda))
@
...
cesCoeffsData_ekl <- filter(coeffs_df, model=="ces", nestStr %in% c("iK+iL", "iQ+iK+iL", "iX+iK+iL", "iU+iK+iL"))
standardScatterPlot(data=cesCoeffsData_ekl, mapping=aes(gamma_coef, lambda), facet_formula=country~nest, alpha=0.05) +
    scale_x_continuous(breaks=c(0.9, 1.0, 1.1)) +
    scale_y_continuous(breaks=c(0, 0.025, 0.05, 0.075)) +    
    labs(x=expression(gamma), y=expression(lambda))
@
...
standardScatterPlot(data=cesCoeffsData_kle, mapping=aes(delta_1, sigma_1), facet_formula=country~nest, alpha=0.05) +
    coord_trans(y="sigma") +
    scale_x_continuous(breaks=c(0, 0.5, 1.0, 2.0)) +
    scale_y_continuous(breaks=c(0, 0.5, 1.0, 2.0)) +
    labs(x=expression(delta[1]), y=expression(sigma[1]))
...
standardScatterPlot(data=cesCoeffsData_lek, mapping=aes(delta_1, sigma_1), facet_formula=country~nest, alpha=0.05) +
    coord_trans(y="sigma") +
    scale_x_continuous(breaks=c(0, 0.5, 1.0, 2.0)) +
    scale_y_continuous(breaks=c(0, 0.5, 1.0, 2.0)) +
    labs(x=expression(delta[1]), y=expression(sigma[1]))
...
standardScatterPlot(data=cesCoeffsData_ekl, mapping=aes(delta_1, sigma_1), facet_formula=country~nest, alpha=0.05) +
    coord_trans(y="sigma") +
    scale_x_continuous(breaks=c(0, 0.5, 1.0, 2.0)) +
    scale_y_continuous(breaks=c(0, 0.5, 1.0, 2.0)) +
    labs(x=expression(delta[1]), y=expression(sigma[1]))
...
standardScatterPlot(data=subset(cesCoeffsData_kle, nestStr != "iK+iL"),
                    mapping=aes(delta, sigma), facet_formula=country~nest, alpha=0.05) +
    coord_trans(y="sigma") +
    scale_x_continuous(breaks=c(0, 0.5, 1.0, 2.0)) +
    scale_y_continuous(breaks=c(0, 0.5, 1.0, 2.0)) +
...
standardScatterPlot(data=subset(cesCoeffsData_lek, nestStr != "iK+iL"),
                    mapping=aes(delta, sigma), facet_formula=country~nest, alpha=0.05) +
    coord_trans(y="sigma") +
    scale_x_continuous(breaks=c(0, 0.5, 1.0, 2.0)) +
    scale_y_continuous(breaks=c(0, 0.5, 1.0, 2.0)) +
...
standardScatterPlot(data=subset(cesCoeffsData_ekl, nestStr != "iK+iL"),
                    mapping=aes(delta, sigma), facet_formula=country~nest, alpha=0.05) +
    coord_trans(y="sigma") +
    scale_x_continuous(breaks=c(0, 0.5, 1.0, 2.0)) +
    scale_y_continuous(breaks=c(0, 0.5, 1.0, 2.0)) +
...
standardTriPlot(data=cesCoeffsData_kle, facet_formula=country~nest)
@
...
standardTriPlot(data=cesCoeffsData_lek, facet_formula=country~nest)
@
...
standardTriPlot(data=cesCoeffsData_ekl, facet_formula=country~nest)
@
...
cesFittedData <- filter(fitted_df, model=="ces", nest %in% c("iK+iL", "iK+iL+iQ", "iK+iL+iX", "iK+iL+iU"))
spaghettiPlot(data=cesFittedData, facet_formula=Country~nest, level=spaghettiGraphLevel) +
    labs(y="Indexed GDP (1980=1 or 1991=1)")
@
...
cesFittedData <- filter(fitted_df, model=="ces", nest %in% c("iK+iL", "iL+iQ+iK", "iL+iX+iK", "iL+iU+iK"))
spaghettiPlot(data=cesFittedData, facet_formula=Country~nest, level=spaghettiGraphLevel) +
    labs(y="Indexed GDP (1980=1 or 1991=1)")
@
...
cesFittedData <- filter(fitted_df, model=="ces", nest %in% c("iK+iL", "iQ+iK+iL", "iX+iK+iL", "iU+iK+iL"))
spaghettiPlot(data=cesFittedData, facet_formula=Country~nest, level=spaghettiGraphLevel) +
    labs(y="Indexed GDP (1980=1 or 1991=1)")
@
