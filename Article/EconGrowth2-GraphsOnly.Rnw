...
cesCoeffsData_kle <- filter(coeffs_df, model=="ces", nestStrParen %in% c("(iK + iL) + ()", "(iK + iL) + (iQ)", "(iK + iL) + (iX)", "(iK + iL) + (iU)"))
...
cesCoeffsData_lek <- filter(coeffs_df, model=="ces", nestStrParen %in% c("(iK + iL) + ()", "(iL + iQ) + (iK)", "(iL + iX) + (iK)", "(iL + iU) + (iK)"))
...
cesCoeffsData_ekl <- filter(coeffs_df, model=="ces", nestStrParen %in% c("(iK + iL) + ()", "(iQ + iK) + (iL)", "(iX + iK) + (iL)", "(iU + iK) + (iL)"))
...
cesFittedData <- filter(fitted_df, model=="ces", nestStrParen %in% c("(iK + iL) + ()", "(iK + iL) + (iQ)", "(iK + iL) + (iX)", "(iK + iL) + (iU)"))
...
cesFittedData <- filter(fitted_df, model=="ces", nestStrParen %in% c("(iK + iL) + ()", "(iL + iQ) + (iK)", "(iL + iX) + (iK)", "(iL + iU) + (iK)"))
spaghettiPlot(data=cesFittedData, facet_formula=Country~nestStrParen, level=spaghettiGraphLevel) +
    labs(y="Indexed GDP (1980=1 or 1991=1)")
@
...
cesFittedData <- filter(fitted_df, model=="ces", nestStrParen %in% c("(iK + iL) + ()", "(iQ + iK) + (iL)", "(iX + iK) + (iL)", "(iU + iK) + (iL)"))
spaghettiPlot(data=cesFittedData, facet_formula=Country~nestStrParen, level=spaghettiGraphLevel) +
    labs(y="Indexed GDP (1980=1 or 1991=1)")
@
...
data <- fortify(oModels$Calvin$CN$linex$`iK+iL+iQ`)
