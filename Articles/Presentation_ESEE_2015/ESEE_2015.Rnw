...
myXTable(filter(AllCoeffs, (model=="CES" & flavor=="Unadjusted" & energy=="Without energy") | model=="exp") %>% 
           select(Country, model, cst, gamma, lambda, alpha_1, alpha_2, sigma_1, mse),
...
myXTable(filter(AllCoeffs, model=="CES" | model=="exp") %>% 
           select(Country, model, flavor, energy, nest, cst, gamma, lambda, alpha_1, alpha_2, alpha_3),
...
myXTable(filter(AllCoeffs, model=="CES" | model=="exp") %>% 
           select(Country, model, flavor, energy, nest, cst, sigma_1, sigma, mse),
         caption="Model parameters for all CES models.",
         label=paste0("tab:", opts_current$get("label")), 
         digits=6)
@
