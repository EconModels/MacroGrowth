...
<<Historical Data, fig.pos="H", fig.align='center', fig.width=6.6, fig.height=7, fig.cap="Historical data.">>=
mdata <- melt(historicalData, 
              measure.vars = c(as.character(y_PT), 
                               as.character(k_PT_unadj), as.character(l_PT_unadj), as.character(e_PT_unadj),
                               as.character(k_PT_adj), as.character(l_PT_adj), as.character(e_PT_adj),
                               as.character(y_UK), 
                               as.character(k_UK_unadj), as.character(l_UK_unadj), as.character(e_UK_unadj),
                               as.character(k_UK_adj), as.character(l_UK_adj), as.character(e_UK_adj)), 
...
ggplot(mdata, mapping=aes(x=Year, y=value, group=variable) + 
  geom_line(mapping) +
