...
L_PT_unadj <- "iL"
E_PT_unadj <- "iXpMP"
# Partugal quality-adjusted inputs
K_PT_adj <- "iKservS.L"
L_PT_adj <- "ihLest"
E_PT_adj <- "iUMP"
# UK unadjusted inputs
K_UK_unadj <- "iKstkO.WwithRD"
L_UK_unadj <- "iL"
E_UK_unadj <- "iXp"
# UK quality-adjusted inputs
K_UK_adj <- "iKservO.WwithRD"
L_UK_adj <- "ihLest"
E_UK_adj <- "iU"
# Time variables
time_PT <- "iYear"
...
# To do this, use the substitute function.
...
# 
# 
# f_PT_unadj_woe <- substitute(y ~ k + l + t, list(y = y_PT,
#                                                  k = K_PT_unadj,
#                                                  l = L_PT_unadj,
#                                                  t = time_PT))
# y_PT
...
# ptCESkleunadjNoE <- cesModel(formula = iGDP ~ iKstkS.L + iL + iYear, 
#                nest = c(1,2,3), data = dataPT, constrained = TRUE)
# naturalCoef(ptCESkleunadjNoE)
ptCESkleunadjWithE <- cesModel(formula = iGDP ~ iKstkS.L + iL + iXpMP + iYear, 
                            nest = c(1,2,3), data = dataPT, constrained = TRUE)
...
# Not working at this time.
# ptCESkleadjNoE <- cesModel(formula = iGDP ~ iKservS.L + ihLest + iYear, 
#                         nest = c(1,2,3), data = dataPT, constrained = TRUE)
# naturalCoef(ptCESkleadjNoE)
ptCESkleadjWithE <- cesModel(formula = iGDP ~ iKservS.L + ihLest + iUMP + iYear, 
                          nest = c(1,2,3), data = dataPT, constrained = TRUE)
  ...
  \begin{center}
    \begin{tabular}{r c c} 
      \toprule
                      & Unadjusted     & Quality-adjusted   \\
      \midrule
%      Without energy  & \Sexpr{naturalCoef(ptCESkleunadjNoE)$lambda}      & \Sexpr{naturalCoef(ptCESkleadjNoE)$lambda} \\
...
# Not working at this time.
# ptCESlekunadjNoE <- cesModel(formula = iGDP ~ iKstkS.L + iL + iYear, 
#                nest = c(2,3,1), data = dataPT, constrained = TRUE)
# naturalCoef(ptCESlekunadjNoE)
ptCESlekunadjWithE <- cesModel(formula = iGDP ~ iKstkS.L + iL + iXpMP + iYear, 
                            nest = c(2,3,1), data = dataPT, constrained = TRUE)
...
# Not working at this time.
# ptCESlekadjNoE <- cesModel(formula = iGDP ~ iKservS.L + ihLest + iYear, 
#                         nest = c(2,3,1), data = dataPT, constrained = TRUE)
# naturalCoef(ptCESlekadjNoE)
ptCESlekadjWithE <- cesModel(formula = iGDP ~ iKservS.L + ihLest + iUMP + iYear, 
                          nest = c(2,3,1), data = dataPT, constrained = TRUE)
  ...
  \begin{center}
    \begin{tabular}{r c c} 
      \toprule
                      & Unadjusted     & Quality-adjusted   \\
      \midrule
%      Without energy  & \Sexpr{naturalCoef(ptCESlekunadjNoE)$lambda}      & \Sexpr{naturalCoef(ptCESlekadjNoE)$lambda} \\
...
# Not working at this time.
# ptCESeklunadjNoE <- cesModel(formula = iGDP ~ iKstkS.L + iL + iYear, 
#                nest = c(3,1,2), data = dataPT, constrained = TRUE)
# naturalCoef(ptCESeklunadjNoE)
ptCESeklunadjWithE <- cesModel(formula = iGDP ~ iKstkS.L + iL + iXpMP + iYear, 
                            nest = c(3,1,2), data = dataPT, constrained = TRUE)
...
# Not working at this time.
# ptCESekladjNoE <- cesModel(formula = iGDP ~ iKservS.L + ihLest + iYear, 
#                         nest = c(3,1,2), data = dataPT, constrained = TRUE)
# naturalCoef(ptCESekladjNoE)
ptCESekladjWithE <- cesModel(formula = iGDP ~ iKservS.L + ihLest + iUMP + iYear, 
                          nest = c(3,1,2), data = dataPT, constrained = TRUE)
  ...
  \begin{center}
    \begin{tabular}{r c c} 
      \toprule
                      & Unadjusted     & Quality-adjusted   \\
      \midrule
%      Without energy  & \Sexpr{naturalCoef(ptCESeklunadjNoE)$lambda}      & \Sexpr{naturalCoef(ptCESekladjNoE)$lambda} \\
