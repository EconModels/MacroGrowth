...
coeffs_df <- loadPostProcessedData(Source = "REXS", kind = "coeffs")
# Load fitted data from all models in one large data frame
fitted_df <- loadPostProcessedData(Source = "REXS", kind = "fitted")
# Load the original models.
oModels <- loadPostProcessedData(Source = "REXS", kind = "models")
@
