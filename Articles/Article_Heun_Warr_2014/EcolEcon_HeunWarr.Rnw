...
cdCoeffsData <- filter(coeffs_df, model=="cd", nestStr %in% c("iK+iL", "iK+iL+iX", "iK+iL+iU"))
...
cdFittedData <- filter(fitted_df, model=="cd", nestStr %in% c("iK+iL", "iK+iL+iX", "iK+iL+iU"))
...
linexCoeffsData <- filter(coeffs_df, model=="linex", energy %in% c("iX", "iU"))
...
linexFittedData <- filter(fitted_df, model=="linex", energy %in% c("iX", "iU"))
