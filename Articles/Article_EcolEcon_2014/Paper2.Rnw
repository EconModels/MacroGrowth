...
Figure~\ref{fig:Historical_Data} shows a graph of historical data.

<<Historical_Data, fig.pos="H", fig.align='center', fig.width=6.6, fig.height=3, fig.cap="Historical data.">>=
historicalPlot(historicalData, 
               facet_formula = Country ~ Source, 
               lines_formula = iGDP + iK + iL + iXp + iXf + iU ~ Year, 
