...
cesCoeffsDataX <- filter(AllCoeffs, model=="ces", nestStrParen %in% c("(iK + iL) + ()", 
                                                                      "(iK + iL) + (iXp)", 
                                                                      "(iL + iXp) + (iK)", 
                                                                      "(iXp + iK) + (iL)"))
standardScatterPlot(data=cesCoeffsDataX, mapping=aes(x=gamma_coef, y=lambda, color=Source), 
