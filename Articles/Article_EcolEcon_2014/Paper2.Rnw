...
All_Models <- unlist(list(REXS1960_Models, IST_Models, Leeds_Models), recursive=FALSE)
...
residual_data <- leaf_apply(All_Models, extract_data, class=c("CDEmodel", "cesEst", "LINEXModel"))
...
<<CD_Residual_Plot, fig.pos="H", fig.align='center', fig.width=4, fig.height=2.5, fig.cap="Cobb-Douglas Residual Plots.">>=
