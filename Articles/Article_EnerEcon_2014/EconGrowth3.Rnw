...
rebound and backfire effects.%
  \footnote{
  See \citet{Sorrell:2007um} for details about rebound and backfire effects.
  }
...
Thus, both the choice of production function structure 
...
Thus, we support the call from \citet{Shen:2013vp} that both
