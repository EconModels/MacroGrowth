...
If the LINEX function is to be used, 
we recommend that \citeapos{Kummel:2011aa} fitting approach 
(energy quantified by primary thermal energy and logistic curves for $a_0$ and $c_t$) 
or \citeapos{Ayres:2010ug} approach (energy quantified by useful work and constant values for $a_0$ and $c_t$) 
be employed 
