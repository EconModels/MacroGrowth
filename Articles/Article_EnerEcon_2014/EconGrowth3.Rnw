...
**** For the time being, I've added two of these tables, US and UK.
We can add the remaining seven tables easily, either here or in an appendix. 
Data to fill the appendices is in the Word document on Dropbox. --MKH ****
