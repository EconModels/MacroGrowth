...
Furthermore, the \emph{cost share theorem} from mainstream economics states that 
output elasticities 
...
than capital~($K$) and/or labor~($L$) markets, 
...
**** Suggest moving content of the literature review section up to this point. --MKH ****

**** Suggest deleting the next sentences:
...
**** Merge the literature review into the Introduction? 
We're already doing some literature review in the Introduction. --MKH ****
...
rebound, backfire, and super-conservation effects.~\citep{Sorrell:2007um}
\citeauthor{Saunders:2008aa} concludes that only the CES function is a candidate for 
rebound analysis.
...
\citep{Beckman:2011gb, Benes:2012tm, Nel:2010fv, Kummel:2010vz}.  
...
**** The previous sentences sound a lot like we'll show that some groups of countries
...
individually. 
We should consider revising the few sentences. --MKH ****
