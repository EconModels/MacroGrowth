...
Technological change is manifest in these efficiencies,
as more useful work is done per joule of exergy \citep{Ayres:2005kn}.
...
*** One item from previous version of paper led me to a question that could be answered by our approach:
Is it true that economies at similar stages of development will have similar
$\alpha$, $\beta$, and $\gamma$ values? ****

**** Another question to address: Would better data reduce the uncertainty in parameter estimates?
Probably not. The US, presumably the best data in the world, still shows very high uncertainty. ****
