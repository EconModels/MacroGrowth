...
summary(mod_PT_uakl_qae)
naturalCoef(mod_PT_uakl_qae)
sum(resid(mod_PT_uakl_qae)^2)
...
summary(mod_PT_qakl_uae)
naturalCoef(mod_PT_qakl_uae)
sum(resid(mod_PT_qakl_uae)^2)
...
summary(mod_UK_uakl_qae)
naturalCoef(mod_UK_uakl_qae)
sum(resid(mod_UK_uakl_qae)^2)
...
summary(mod_UK_qakl_uae)
naturalCoef(mod_UK_qakl_uae)
sum(resid(mod_UK_qakl_uae)^2)
