  ...
  AllCoeffs %>% 
    ...
    mutate(nest = plyr::mapvalues(nest, 
           ...
           type = plyr::mapvalues(type,
                                  from=c("sigma_12", "sigma_23", "sigma_13", "sigma_12_3", "sigma_23_1", "sigma_13_2"),
                                  to  =c("sigma_kl", "sigma_le", "sigma_ek", "sigma_kl_e", "sigma_le_k", "sigma_ek_l")),
           type = relevelFactor(type, c("sigma_kl", "sigma_le", "sigma_ek", "sigma_kl_e", "sigma_le_k", "sigma_ek_l")),
           Model = interaction(nest, CSP, sep = " ", drop=TRUE),
           Inputs = flavor
           )
  ) + 
    ...
    AllCoeffs %>% 
      ...
      mutate(nest = plyr::mapvalues(nest, 
             ...
             type = plyr::mapvalues(type,
                                    from=c("sigma_12", "sigma_23", "sigma_13", "sigma_12_3", "sigma_23_1", "sigma_13_2"),
                                    to  =c("sigma_kl", "sigma_le", "sigma_ek", "sigma_kl_e", "sigma_le_k", "sigma_ek_l")),
             type = relevelFactor(type, rev(c("sigma_kl", "sigma_le", "sigma_ek", "sigma_kl_e", "sigma_le_k", "sigma_ek_l")))
             )
    ) + 
  geom_point(aes(x=value, y=type, 
                 shape = Model, fill=Model, size=Model#,
