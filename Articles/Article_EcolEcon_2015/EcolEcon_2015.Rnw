...
Clean up labeling, etc. later.

<<sigma_graph_2, fig.pos="H", fig.align='center', fig.width=8.5, fig.height=5, out.width="0.9\\textwidth", fig.cap="Elasticities of substitution~($\\sigma$).">>=
p <- 
ggplot(
  AllCoeffs %>% 
  ...
  scale_x_log10(limits = c(0.001,2000), labels=comma) +
  xlab("") +
...
<<sigma_graph, fig.pos="H", fig.align='center', fig.width=7.5, fig.height=3.3, fig.cap="Elasticities of substitution~($\\sigma$) for the UK.", eval=FALSE, include=FALSE>>=
...
<<sigma_graph_PT, fig.pos="H", fig.align='center', fig.width=7.5, fig.height=3.3, fig.cap="Elasticities of substitution~($\\sigma$) for Portugal.", eval=FALSE, include=FALSE>>=
sigma_graph(AllCoeffs %>% filter(model=="CES", Country=="PT"))
@

<<sigma_graph_UK, fig.pos="H", fig.align='center', fig.width=7.5, fig.height=3.3, fig.cap="Elasticities of substitution~($\\sigma$) for the UK.", eval=FALSE, include=FALSE>>=
