...
%++++++++++++++++++++++++++++++
\subsection{$\sigma$ graph} 
\label{sec:sigma_graph}
%++++++++++++++++++++++++++++++

<<sigma_graph>>=
sigma_graph_data <- filter(AllCoeffs, model=="CES") %>% 
  select(Country, CSP, flavor, energy, nest, sigma_12, sigma_23, sigma_13, sigma_12_3, sigma_23_1, sigma_13_2)
# Change nest to a nicer-looking nest string
