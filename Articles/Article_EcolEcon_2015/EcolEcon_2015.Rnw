...
<<sigma_graph_3, fig.pos="H", fig.align='center', fig.width=8.5, fig.height=5, out.width="0.9\\textwidth", fig.cap="Elasticities of substitution~($\\sigma$) with factors of production on the vertical facet.">>=
breaks_labels = c(0.01, 1, 100)
p <- 
ggplot(
  AllCoeffs %>% 
