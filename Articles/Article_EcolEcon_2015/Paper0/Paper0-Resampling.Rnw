...
%
\begin{equation} \label{eq:alpha_x_1}
  \alpha_{x_1} \equiv
  \frac{ \frac{\partial y}{\partial x_1} }
          { \frac{y}{x_1} } 
  = 
  \frac{ \delta  \delta _1 x_1^{-\rho _1} \left[\delta _1 x_1^{-\rho _1} + \left(1 - \delta_1 \right) x_2^{-\rho _1}\right]
                             ^{\frac{\rho}{\rho _1}-1} }
  { \delta \left[\delta _1 x_1^{-\rho _1} + \left(1 - \delta _1 \right) x_2^{-\rho _1} \right]
                             ^{ \frac{\rho }{\rho_1} } 
                + (1 - \delta) x_3^{-\rho }}
\end{equation}
%
\begin{equation} \label{eq:alpha_x_2}
  \alpha_{x_2} \equiv \frac{ \frac{\partial y}{\partial x_2} }{\frac{y}{x_2}} =
  \frac{ \delta  \left(1-\delta _1 \right) x_2^{-\rho _1} \left[\delta _1 x_1^{-\rho _1}+\left(1 - \delta_1\right) x_2^{-\rho_1}\right]
	 				^{\frac{\rho }{\rho _1}-1} }
		{\delta  \left[\delta _1 x_1^{-\rho_1} + \left(1 - \delta_1\right) x_2
                                        ^{-\rho_1}\right]^{\frac{\rho }{\rho _1}}+ (1 - \delta) {x_3}^{-\rho }}
\end{equation}
%
\begin{equation} \label{eq:alpha_x_3}
  \alpha_{x_3} \equiv \frac{ \frac{\partial y}{\partial x_3} }{ \frac{y}{x_3} } =  
      \frac{1 - \delta}{\delta  x_3^{\rho } \left[\delta _1 x_1^{-\rho_1} + \left(1 - \delta_1 \right) x_2^{-\rho _1}\right]
...
\begin{equation} \label{eq:sum_betas}
  \alpha_{x_1} + \alpha_{x_2} + \alpha_{x_3} = 1
\end{equation}
%
for all nests.

Elasticities of substitution~($\sigma$) between factors of production
are a function of $\rho_1$, $\rho$, and nesting. 
**** More here on the actual $\sigma$ equations. 
Gather them from the Henningsen and Henningsen paper. ****
